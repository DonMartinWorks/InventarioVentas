        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ route('home') }}" class="flex ms-2 md:me-24">
                    ...
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">{{ config('app.name', 'Laravel') }}</span>
                </a>
            </div>
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <a href="{{ route('profile.show') }}"
                                        class="block text-center px-4 py-2 text-sm text-gray-700 hover:text-white hover:bg-fuchsia-700 hover:font-semibold transition-all"
